...
| 0.1.2 | 2026.05.26 | 매정시 데이터 갱신 처리 수정 |
| 0.1.1 | 2026.05.25 | 과거데이터 업데이트 로직 수정 |
| 0.1.0 | 2026.05.25 | 메뉴 클릭 미반응 보완 처리 |
| 0.0.9 | 2026.05.24 | 걸음 처리 관련 버그 수정 |
| 0.0.8 | 2026.05.23 | 걸음 측정 관련 수정 및 보완 |
| 0.0.7 | 2026.05.22 | QA 내용 수정 |
| 0.0.6 | 2026.05.22 | 게임에러 메시지 변경 |
